...
// -> gCO2e. Every ReportIntervalSeconds, POSTs {"device_id","carbon_score"}
// to your website.
//
// Build:
//   clang++ -std=c++14 camera_test.cpp -lcamapi -lscreen -lsocket -o camera_test
//
// Run:
//   ./camera_test
//   (Ctrl+C to stop)
...
//
// A camera sees reflected light, not electrical draw, so this is a
// calibrated heuristic, not a power meter. Tune the constants below
